...
const CompanyDetail = () => {
    ...
    const { data: moneyData, error: moneyError, loading: moneyLoading } = useFetch(`${process.env.REACT_APP_BASE_ENDPOINT}/money`);
